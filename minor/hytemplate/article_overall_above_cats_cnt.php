            ...
            <div class="post-buttons">
                ...
                <!--    <span class="screen-reader-text"></?php echo _x('Categories', 'Used before category names.', 'generatepress'); ?> </span> -->
                    ...
                    <span style="color: green;">
                        <?php echo $counter_str; ?><span class="hyplus-unselectable"><?php echo $emoji ? '&nbsp;&nbsp;<a class="hyplus-scale" href="https://www.hyperplasma.top/user/akira37/"  style="text-decoration: none; display: inline-block;" title="受限内容">' . $emoji . '</a>' : ''; ?></span>
                    </span>
                </span>
            </div>
            <?php
