 ...
 * 显示不同地区的当前时间
 * Code type: universal
 * Shortcode: [hyplus_timezone_displayer]
 */
add_shortcode('hyplus_timezone_displayer', 'hyplus_timezone_display_shortcode');

function hyplus_timezone_display_shortcode() {
    $timezones = [
        'China' => 'Asia/Shanghai',
