	...
	<div class="hyplus-nav-section">
		...
		<div class="hyplus-nav-links">
			<div class="hyplus-nav-group">
				...
				<a href="https://www.qianwen.com/" class="hyplus-nav-link" target="_blank">通义千问</a>
	...
	<div class="hyplus-nav-section">
		...
		<div class="hyplus-nav-links">
			...
			<div class="hyplus-nav-group">
				...
				<a href="https://markdowntohtml.com/" class="hyplus-nav-link" target="_blank">MD转HTML</a>
				<a href="https://goldziher.github.io/html-to-markdown/" class="hyplus-nav-link" target="_blank">HTML转MD</a>
	...
	<div class="hyplus-nav-section">
		...
		<div class="hyplus-nav-links">
			...
			<div class="hyplus-nav-group">
				...
				<a href="https://www.cnki.net" class="hyplus-nav-link" target="_blank">知网</a>
				<a href="https://www.ccf.org.cn/Academic_Evaluation/By_category/" class="hyplus-nav-link" target="_blank">CCF推荐目录</a>
				<a href="https://gfsoso.99lb.net" class="hyplus-nav-link" target="_blank">谷粉学术</a>
			</div>
		</div>
	</div>
